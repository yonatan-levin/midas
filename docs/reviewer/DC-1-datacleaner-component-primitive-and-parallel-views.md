...
- Phase 0 closeout report — `docs/refactoring/implementations/datacleaner-component-primitive-and-parallel-views-phase-0-closeout.md` — comprehensive summary of what landed, empirical verification, what's deferred to Phase 1+, and lessons learned.
- Design spec — `docs/refactoring/spec/datacleaner-component-primitive-and-parallel-views-spec.md`
- Phase 0 implementation plan — `docs/refactoring/implementations/datacleaner-component-primitive-and-parallel-views-phase-0-implementation-plan.md`
...
- **➡️ Phase 1 implementation plan** — `docs/refactoring/implementations/datacleaner-component-primitive-and-parallel-views-phase-1-implementation-plan.md` — the authoritative ARCH-approved plan that drove this phase.
- Phase 1 implementer handoff — `docs/refactoring/implementations/datacleaner-component-primitive-and-parallel-views-phase-1-handoff.md` — the originating handoff.
- **Phase 1 closeout report** — `docs/refactoring/implementations/datacleaner-component-primitive-and-parallel-views-phase-1-closeout.md` — filed post-merge. Comprehensive summary of what landed, V-R-Q chain verdicts (REVIEWER 9 findings all addressed in follow-up PR), empirical verification, lessons learned, and 11/11 acceptance criteria status.
