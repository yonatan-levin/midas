...
- **➡️ Phase 1 implementer handoff** — `docs/refactoring/implementations/datacleaner-component-primitive-and-parallel-views-phase-1-handoff.md` — **START HERE when beginning Phase 1.** Includes scope, required-reading list, gotchas, acceptance criteria, and a copy-paste starting prompt.
