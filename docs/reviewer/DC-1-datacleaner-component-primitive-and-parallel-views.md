...
- Phase 1 closeout report (to be filed post-merge) — `docs/refactoring/implementations/datacleaner-component-primitive-and-parallel-views-phase-1-closeout.md`.
- Shadow-analysis report (separate PR after merge) — `docs/refactoring/implementations/datacleaner-component-primitive-and-parallel-views-phase-1-shadow-analysis.md`.
