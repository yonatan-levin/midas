...
- **Phase 0 closeout report** — `docs/refactoring/implementations/datacleaner-component-primitive-and-parallel-views-phase-0-closeout.md` — comprehensive summary of what landed, empirical verification, what's deferred to Phase 1+, and lessons learned. **Read this before starting Phase 1 ARCH.**
