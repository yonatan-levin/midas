...
const docTemplate = `{
    ...
    "definitions": {
        "github_com_midas_dcf-valuation-api_internal_core_entities.AssumptionSourceValue": {
            ...
            "properties": {
                "detail": {
                    "description": "Detail is an optional provenance string, e.g.\n\"accession=0000002488-26-000012 period=FY2026 conf=0.82 midpoint=$1.50B\".",
                    "type": "string"
                },
                "source": {
                    "description": "Source is the precedence layer that supplied this assumption's value.",
                    "type": "string"
                }
            }
        },
        ...
        "internal_api_v1_handlers.CleaningAdjustment": {
            ...
            "properties": {
                "amount": {
                    "description": "Amount is the signed monetary delta the adjuster applied, in USD.",
                    "type": "number",
                    "example": 1234.5
                },
                "category": {
                    "description": "Category is the rule family: \"asset_quality\" | \"liability_completeness\" |\n\"earnings_normalization\".",
                    "type": "string",
                    "example": "asset_quality"
                },
                "from_account": {
                    "description": "FromAccount is the source balance-sheet / income-statement line item.",
                    "type": "string",
                    "example": "Goodwill"
                },
                "percentage": {
                    "description": "Percentage is the proportional change relative to the pre-adjustment\nvalue, when the adjuster reports one (Restater family). Omitted otherwise.",
                    "type": "number",
                    "example": 12.5
                },
                "reasoning": {
                    "description": "Reasoning is the human-readable explanation of why the adjuster fired.",
                    "type": "string",
                    "example": "Excluded goodwill of $1234.5M from invested capital"
                },
                "rule": {
                    "description": "Rule is the config rule identifier that fired (entities.Adjustment.RuleID),\ne.g. \"goodwill_exclusion\", \"contingent_liabilities\", \"right_of_use_assets\".",
                    "type": "string",
                    "example": "goodwill_exclusion"
                },
                "to_account": {
                    "description": "ToAccount is the destination line item for reclassifications; empty for\noverlays and pure exclusions.",
                    "type": "string",
                    "example": "EstimatedLiabilities"
                },
                "type": {
                    "description": "Type is the adjustment kind: \"exclude\" | \"writedown\" | \"valuation_allowance\" |\n\"reclassify\" | \"treat_as_debt\" | \"probability_weighted\" | \"flag\".",
                    "type": "string",
                    "example": "exclude"
                }
            }
