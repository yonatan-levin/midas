...
| 2026-05-24 | Phase 3 SHIPPED on branch `dc1-phase-3`. All 14 tasks completed in single-PR Option A across 8 commits: `014b310` (3.1-3.4 + 3.11 — cleaneddata package skeleton + AsReported / Restated / InvestedCapital accessors + import-boundary test); `7855027` (3.5 — Service.CleanFinancialDataWithViews sibling + MockDataCleanerService mock alignment); `54c14c6` (3.6 — T2-BS-3 carve-out test in cleaneddata package); `708e5ce` (3.9 — ctx threading through all three Process*Adjustments + test-callsite + 5 shadow-fix files via `gocontext "context"` alias); `146c42b` (3.7 + 3.10 — Q2 A2 TaxShieldDTA population + SchemaVersion 8→9 atomic); `4f634a7` (3.8 — Q4 B3 AIProvenance SHA-256 hashes); `deac62b` (3.12 — live AMD/KO Restated reconstruction integration test); `f2fba9a` (3.10 follow-up — bump replay happy-bundle testdata 8→9). Closeout doc filed at `datacleaner-component-primitive-and-parallel-views-phase-3-closeout.md`. |
